...
function Page() {
  ...
  const stats = useMemo(() => {
    ...
    const monthRev = orders.filter(o => o.status !== "cancelado").reduce((a, o) => a + o.total, 0);
            ...
            <div className="h-56">
              <ResponsiveContainer>
                <BarChart data={topProducts} layout="vertical">
                  ...
                  <YAxis type="category" dataKey="name" stroke="var(--muted-foreground)" fontSize={10} width={120} />
                  <Tooltip contentStyle={{ background: "var(--card)", border: "1px solid var(--border)", borderRadius: 12 }} />
