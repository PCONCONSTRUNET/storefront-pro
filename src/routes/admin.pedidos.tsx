              ...
              >
                <div className="flex justify-between items-start gap-3">
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <span className="text-[10px] inline-block mt-1 bg-accent text-accent-foreground px-2 py-0.5 rounded-full font-semibold">
        ...
        <Modal onClose={() => setSelected(null)} title={`Pedido #${order.id}`}>
          <div className="space-y-3 text-sm">
            ...
            <button
              ...
              className="w-full h-10 rounded-full bg-muted font-semibold"
            >
              Imprimir guia
            </button>
            <button
