        ...
        <div className="max-w-md mx-auto text-center py-20 px-4">
          ...
          <div className="mt-6 grid grid-cols-2 gap-3">
            <button
              ...
              className="h-12 rounded-full gradient-primary text-primary-foreground font-semibold flex items-center justify-center"
            >
              Entrar
            </button>
            <button
              ...
              className="h-12 rounded-full border-2 border-primary text-primary font-semibold flex items-center justify-center"
            >
              Cadastrar
            </button>
          </div>
    ...
    <StoreLayout>
      <div className="max-w-2xl mx-auto px-4 py-5">
        ...
        <button
          ...
          className="mt-4 w-full h-12 rounded-full border-2 border-destructive/30 text-destructive font-semibold flex items-center justify-center gap-2"
        >
...
function AuthModal({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-foreground/50 backdrop-blur-sm animate-overlay-in"
      onClick={onClose}
    >
      <div
      ...
      >
        <div className="gradient-primary text-primary-foreground px-4 pt-4 pb-5 relative text-left">
          <button
            onClick={onClose}
            className="absolute right-3 top-3 w-7 h-7 grid place-items-center rounded-full bg-primary-foreground/20 hover:bg-primary-foreground/30 transition-colors"
            aria-label="Fechar"
            type="button"
          >
