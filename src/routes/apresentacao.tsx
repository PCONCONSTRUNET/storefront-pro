...
const slides: Slide[] = [
  ...
  },
  {
    ...
    title: "Home da loja",
    description:
      "Banner principal com a coleção em destaque, atalhos para Tiaras e Kits Presente, selos de confiança e categorias.",
    bullets: [
      "Banner com coleção atual",
      "Atalhos para coleções em destaque",
      "Selos: frete fixo, compra segura, envio rápido, cupons",
  ...
  },
  {
    ...
    bullets: [
      ...
      "Contagem de produtos em tempo real",
    ],
    image: imgCategorias,
  },
  {
    ...
    description:
      "Listagem da categoria com cards ricos: foto, preço, badges e botão de compra direto.",
    bullets: [
      'Badge "Mais vendido" e "-29%"',
      "Avaliações com estrelas",
      "Botão Comprar direto no card",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Selos de frete e compra protegida",
    ],
    image: imgProduto,
  },
  {
  ...
  },
  {
    ...
    description:
      "Formulário simples para a revendedora criar sua conta. A administradora aprova e define a comissão depois.",
    bullets: [
      "Nome, e-mail, WhatsApp e senha",
      "Comissão definida pela admin após o cadastro",
  ...
  },
  {
    ...
    description:
      "Formulário rápido onde a afiliada registra cada venda. A comissão é calculada automaticamente conforme o percentual definido.",
    bullets: [
      "Cliente, WhatsApp, produto e valor",
      "Canal de venda: WhatsApp, Instagram, Presencial",
  ...
  },
  {
    ...
    title: "Minhas vendas",
    description:
      "Listagem das vendas registradas pela afiliada com status (pendente, confirmada ou cancelada) e comissão de cada uma.",
    bullets: [
      "Histórico completo da afiliada",
      "Status visível por venda",
      "Comissão acumulada em destaque",
  ...
  },
  {
    ...
    description:
      "Visão geral de desempenho: vendas, faturamento, comissão e gráfico de evolução do período.",
    bullets: [
      "Filtros: diário, semanal, mensal, personalizado",
      "KPIs de faturamento e comissão",
  ...
  },
  {
    ...
    description:
      "Métricas-chave do dia, gráfico semanal de faturamento, mais vendidos e estoque crítico — tudo em uma tela.",
    bullets: [
      "Faturamento, pedidos, ticket médio e clientes",
  ...
  },
  {
    ...
    description:
      "Lista completa do catálogo com foto, SKU, preço, estoque e status. Edição e exclusão em um clique.",
    bullets: [
      "Tabela com foto, SKU, preço e estoque",
      "Status Ativo/Inativo",
      "Editar ou excluir direto da lista",
      "Botão + Novo para cadastro rápido",
    ],
  ...
  },
  {
    ...
    bullets: [
      ...
      "Reembolso e cancelamento controlados",
    ],
  ...
  },
  {
    ...
    description:
      "Crie cupons percentuais ou em valor, com mínimo de compra, limite de usos e validade.",
    bullets: [
      "3 cupons já configurados",
      "Controle de uso (12/100, 7/50…)",
  ...
  },
  {
    ...
    description:
      "Cadastro e controle das revendedoras: status, percentual de comissão e indicadores de cada uma.",
    bullets: [
      "Cadastro de novas afiliadas",
      "Comissão e status (Ativa/Inativa)",
      "Vendas pagas e comissões pagas em destaque",
      "Acesso direto ao link da afiliada",
    ],
  ...
  },
  {
    ...
    description:
      "Vendas registradas por todas as afiliadas em um só lugar. A admin confirma, cancela ou exclui.",
    bullets: [
      "Filtro por status e por afiliada",
      "Confirmar ou cancelar venda em 1 clique",
...

  {
    ...
    subtitle:
      "Loja, afiliadas e admin em uma única plataforma — feita sob medida para o Princesa de Laços.",
  },
];
  ...
  return (
    ...
    >
      ...
      <header className="h-12 px-4 flex items-center justify-between border-b border-white/10 bg-slate-900/60 backdrop-blur">
        ...
        <div className="flex items-center gap-3 text-xs text-slate-400">
          ...
          <button
            ...
            className="hover:text-white p-1.5 rounded-md hover:bg-white/10"
            title="Tela cheia (F)"
          >
      ...
      <div className="flex-1 grid place-items-center p-6 md:p-10 relative overflow-hidden">
        <div
          key={i}
          className="w-full max-w-6xl aspect-[16/9] bg-white text-slate-900 rounded-2xl shadow-2xl overflow-hidden animate-page-in"
        >
          {renderSlide(s)}
        </div>
        ...
        <button
          onClick={() => go(-1)}
          disabled={i === 0}
          className="absolute left-3 md:left-6 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 grid place-items-center disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
        >
        ...
        <button
          onClick={() => go(1)}
          disabled={i === total - 1}
          className="absolute right-3 md:right-6 top-1/2 -translate-y-1/2 h-12 w-12 rounded-full bg-white/10 hover:bg-white/20 border border-white/20 grid place-items-center disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
        >
      ...
      <footer className="px-6 py-3 border-t border-white/10 bg-slate-900/60">
        ...
        <p className="text-[10px] text-slate-500 mt-2 text-center">
          Use ← → ou espaço para navegar · F para tela cheia
        </p>
      </footer>
    </div>
  );
...
function renderSlide(s: Slide) {
    ...
    return (
      <div className="w-full h-full bg-gradient-to-br from-pink-500 via-rose-400 to-amber-300 text-white p-12 md:p-16 flex flex-col justify-center relative overflow-hidden">
        ...
        <div className="relative">
          ...
          <h1 className="font-semibold text-5xl md:text-7xl mt-6 leading-[1.05] tracking-tight">
            {s.title}
          </h1>
          <p className="text-lg md:text-xl mt-4 opacity-95 max-w-2xl leading-relaxed">
            {s.subtitle}
          </p>
        </div>
      </div>
  ...
  if (s.kind === "section") {
    ...
    return (
      <div
        className={`w-full h-full bg-gradient-to-br ${s.color} text-white p-16 flex flex-col justify-center relative overflow-hidden`}
      >
  ...
  if (s.kind === "outro") {
    return (
      <div className="w-full h-full bg-gradient-to-br from-slate-900 via-pink-900 to-rose-700 text-white p-16 flex flex-col justify-center items-center text-center relative overflow-hidden">
        ...
        <h2 className="font-semibold text-5xl md:text-6xl mt-6 tracking-tight relative">
          {s.title}
        </h2>
        <p className="text-lg md:text-xl mt-4 opacity-90 max-w-2xl relative leading-relaxed">
          {s.subtitle}
        </p>
      </div>
    );
