        ...
        >
          ...
          <div className="flex gap-2">
            <input
              ...
              className="flex-1 h-11 px-3 rounded-xl bg-background border border-border outline-none focus:ring-2 focus:ring-primary/40"
            />
            <button className="h-11 px-4 rounded-xl gradient-primary text-primary-foreground font-semibold inline-flex items-center gap-1">
            ...
            {list.map((a, i) => (
              <li key={i} className="flex items-center gap-3 p-4">
                ...
                <button
                  ...
                  className="text-destructive p-1.5 rounded-md hover:bg-destructive/10"
                >
