  ...
  return (
    <StoreLayout>
      <div className="max-w-5xl mx-auto px-4 py-5">
        ...
        <h1 className="text-xl font-bold mb-4 flex items-center gap-2"><Heart className="h-5 w-5 text-primary" /> Favoritos</h1>
          ...
          if (favProducts.length === 0) {
            return (
              <div className="text-center py-16">
                ...
                <p className="text-sm text-muted-foreground mt-3">Você ainda não tem favoritos.</p>
                <Link to="/" className="mt-4 inline-block text-primary text-sm font-semibold underline">Ver produtos</Link>
              </div>
            );
          }
          return (
