...
function Page() {
  ...
  const onWhatsApp = (o) => {
    ...
    const txt = encodeURIComponent(`Olá ${o.customerName.split(" ")[0]}! Sobre seu pedido #${String(o.id).slice(0, 5).toUpperCase()}…`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminLayout, { title: "Pedidos", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0 flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-sm truncate", children: [
              "#",
              String(o.id).slice(0, 5).toUpperCase(),
              " · ",
              o.customerName
            ] }),
    ...
    order && (() => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsx(Modal, { onClose: () => setSelected(null), title: `Pedido #${String(order.id).slice(0, 5).toUpperCase()}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
