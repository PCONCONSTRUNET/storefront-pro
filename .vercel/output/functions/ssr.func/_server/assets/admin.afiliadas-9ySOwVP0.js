...
import { u as useStore, h as ShoppingBag, v as brl, a as Search, w as Plus, z as Trash2, t as toast, a8 as Download, A as playBeep, E as Clock, X, o as cn } from "./router-CbsSSRKz.js";
import { A as AdminLayout, U as Users, F as FileText } from "./AdminLayout-IA_uuXcZ.js";
import { P as Pencil, d as downloadCSV, a as downloadPDF } from "./export-B47UHtOc.js";
...
import { P as Phone } from "./phone-CEc4-Oe5.js";
import { M as Mail } from "./mail-BQvQoYV3.js";
      ...
      filteredAffiliates.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground text-center py-8", children: affiliates.length === 0 ? "Nenhuma afiliada cadastrada." : "Nenhum resultado para a busca." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: filteredAffiliates.map((a) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { onClick: () => setViewing(a), className: "border-b border-border last:border-0 cursor-pointer hover:bg-muted/40 transition-colors", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2 pr-2 text-muted-foreground", children: a.email?.endsWith("@pendente.com") ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground/50 italic text-xs", children: "Não informado" }) : a.email }),
...
function ConsignmentsPanel({
  ...
  const load = async () => {
    ...
    try {
      const {
        listConsignmentsFn
      } = await import("./router-CbsSSRKz.js").then((n) => n.af);
...
function RegisterSaleModal({
  ...
  const handleSubmit = async (e) => {
    ...
    if (creatingNewAff) {
      ...
      const {
        cloud
      } = await import("./router-CbsSSRKz.js").then((n) => n.ag);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed inset-0 z-50 bg-black/60 backdrop-blur-sm grid place-items-center p-4 animate-overlay-in", onClick: onClose, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { onClick: (e) => e.stopPropagation(), className: "bg-card rounded-3xl w-full max-w-lg max-h-[90vh] overflow-hidden flex flex-col shadow-soft animate-modal-in", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-5 overflow-y-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-2 mb-4", children: [
        ...
        !affiliate.email?.endsWith("@pendente.com") ? /* @__PURE__ */ jsxRuntimeExports.jsxs("a", { href: `mailto:${affiliate.email}`, className: "h-10 rounded-xl bg-primary/10 text-primary text-xs font-semibold flex items-center justify-center gap-1 hover:bg-primary/20 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3.5 w-3.5" }),
          " E-mail"
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-10 rounded-xl bg-muted/50 text-muted-foreground text-xs font-semibold flex items-center justify-center gap-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "h-3.5 w-3.5" }),
          " Não informado"
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: () => {
