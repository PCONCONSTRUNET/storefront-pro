...
import { g as createLucideIcon, u as useStore, W as normalizeOrderStatus, v as brl, w as Plus, a8 as Download, t as toast, h as ShoppingBag, I as formatDate, z as Trash2, X } from "./router-CbsSSRKz.js";
import { A as AdminLayout, F as FileText, U as Users } from "./AdminLayout-IA_uuXcZ.js";
import { d as downloadCSV, a as downloadPDF, P as Pencil } from "./export-B47UHtOc.js";
import { T as TrendingUp } from "./trending-up-D6tJUjsr.js";
import { T as TrendingDown } from "./trending-down-CnT_7V0L.js";
import { F as Funnel } from "./funnel-s0It4ZBA.js";
...
function Page() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(AdminLayout, { title: "Financeiro", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card rounded-2xl shadow-card overflow-hidden", children: [
      ...
      filteredRows.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center py-12 text-muted-foreground", children: "Sem movimentações." }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-border", children: filteredRows.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "p-4 flex justify-between items-start gap-3", style: {
        borderLeft: `4px solid ${r.isOut ? "#ef4444" : "#22c55e"}`
      }, children: [
